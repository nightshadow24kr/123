...
pkgdatadir = $(datadir)/moonex
pkgincludedir = $(includedir)/moonex
pkglibdir = $(libdir)/moonex
pkglibexecdir = $(libexecdir)/moonex
...
ACLOCAL = ${SHELL} /tmp/moonex/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /tmp/moonex/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /tmp/moonex/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /tmp/moonex/build-aux/missing automake-1.15
AWK = gawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = moonex-cli
BITCOIN_DAEMON_NAME = moonexd
BITCOIN_GUI_NAME = moonex-qt
BITCOIN_TX_NAME = moonex-tx
...
COPYRIGHT_HOLDERS_FINAL = The moonex Core developers
COPYRIGHT_HOLDERS_SUBSTITUTION = moonex Core
COPYRIGHT_YEAR = 2019
CPP = gcc -E
...
MAINT = 
MAKEINFO = ${SHELL} /tmp/moonex/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = moonex
PACKAGE_BUGREPORT = https://github.com/moonex-project/moonex/issues
PACKAGE_NAME = moonex Core
PACKAGE_STRING = moonex Core 1.0.0
PACKAGE_TARNAME = moonex
PACKAGE_URL = https://moonex.org/
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /tmp/moonex
abs_srcdir = /tmp/moonex
abs_top_builddir = /tmp/moonex
abs_top_srcdir = /tmp/moonex
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /tmp/moonex/build-aux/install-sh
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  ...
  $(OSX_APP)/Contents/MacOS/moonex-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
$(OSX_APP)/Contents/MacOS/moonex-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/moonex-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/moonex-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
